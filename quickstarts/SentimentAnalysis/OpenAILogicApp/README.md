...
![Step on Logic App](../../../images/sentimentanalysis/logicapps/step1.jpg)  

### OpenAI  
2. Add the OpenAI Key to the Initialize OpenAIKey step.  
![Step on Logic App](../../../images/sentimentanalysis/logicapps/step2oai.jpg)  
...
3. Using a tool like Postman, post a query to the url found in the http trigger   
    ...
    ```
    ![Http trigger](../../../images/sentimentanalysis/logicapps/step3oai.jpg)  
    ![OpenAI Postman](../../../images/sentimentanalysis/logicapps/step3oaipostman.jpg)  
...
![Step on Logic App](../../../images/sentimentanalysis/logicapps/step2azoai.jpg)  
...
3. Using a tool like Postman, post a query to the url found in the http trigger   
    ...
    ```  
    ![Http trigger](../../../images/sentimentanalysis/logicapps/step3oai.jpg)  
    ![OpenAI Postman](../../../images/sentimentanalysis/logicapps/step3azureoaipostman.jpg)
